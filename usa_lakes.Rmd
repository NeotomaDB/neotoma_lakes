...
This is a rewrite of the original document, that attempts to run the lake size runs within an RMarkdown document for more efficient review and analysis.
...
For this work we download Neotoma datasets using the R package.  We do this state by state, intersecting the state level data with the National Hydrology database.
